...
import {
  addLastError, ADD_LAST_ERROR,
  clearLastError, CLEAR_LAST_ERROR,
  ErrorsAction, errorsReducer,
  ErrorsState, getErrors,
  getLastError,
...
describe('errors reducer', () => {
  ...
  describe('when receiving not relative action', () => {
    it('should return default state', () => {
      const newState = errorsReducer(errorsState, { type: 'RANDOM_NAME' } as ErrorsAction);
