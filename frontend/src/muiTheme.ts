...
const rawTheme: any = {
  ...
  colors: {
    // this is custom field to store theme related color data
    ...
    MuiInput: {
      ...
      underline: {
        ...
        "&:after": {
          ...
          borderImage:
            "linear-gradient(145.53deg, #4A0E04 0%, #BAA297 100%) 47% 0%",
        },
        "&&&&:hover:before": {
          ...
          borderImage:
            "linear-gradient(145.53deg, #845A51 0%, #845A51 100%) 47% 0%",
        },
        "&$disabled": {
          "&&&&:hover:before": {
            borderWidth: "0 0 1px 0",
            ...
            borderImageSlice: "1px",
            borderImage:
              "linear-gradient(145.53deg, #4A4A4A 0%, #BABABA 100%) 47% 0%",
          },
          "&:before": {
            borderWidth: "0 0 1px 0",
            borderStyle: "solid",
