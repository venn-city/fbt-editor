...
describe("ProjectItemProvider", () => {
  ...
  describe("createItem", () => {
    it(`should create file`, async (done) => {
      ...
      spyOn(S3BucketRepository.prototype, "putContentObject").and.returnValue(
        Promise.resolve(<AWS.S3.Types.PutObjectOutput>{})
      );
      const result: boolean = await projectItemProvider.createItem(
        createItemRequest
      );
    ...
    it(`should create folder`, async (done) => {
      ...
      spyOn(S3BucketRepository.prototype, "putObject").and.returnValue(
        Promise.resolve(<AWS.S3.Types.PutObjectOutput>{})
      );
      const result: boolean = await projectItemProvider.createItem(
        createItemRequest
  ...
  describe("createFile", () => {
    it(`should create file`, async (done) => {
      ...
      const result: boolean = await projectItemProvider.createFile(
        projectId,
        projectFileId,
        createTranslationTargetFile()
      );
  ...
  describe("deleteFile", () => {
    it(`should delete file`, async (done) => {
      spyOn(S3BucketRepository.prototype, "deleteObject").and.returnValue(
        Promise.resolve(<AWS.S3.Types.DeleteObjectOutput>{})
      );
      const result: boolean = await projectItemProvider.deleteFile(
        projectId,
        projectFileId
      );
  ...
  describe("uploadItem", () => {
    it(`should upload file`, async (done) => {
      const file: UploadedFile = {
        ...
        data: Buffer.from(
          JSON.stringify(createTranslationSourceFile()),
          "utf8"
        ),
      } as UploadedFile;
      spyOn(S3BucketRepository.prototype, "putContentObject").and.returnValue(
      ...
      spyOn(ProjectProvider.prototype, "getSourceFileName").and.returnValue(
        sourceFileName
      );
      const result: boolean = await projectItemProvider.uploadItem(
        projectId,
        parentFolderId,
        file
      );
